...
@end
@interface CMuneItem()<CAAnimationDelegate>
@end
...
-(void)itemHideWithPoint:(CGPoint)point{
    ...
    groupAnimation = [AnimationTool groupAnimationWithAnimations:@[scaleAnimation,keyframeAnimation,opacityAnimation] duration:0.4];
